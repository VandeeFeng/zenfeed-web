<script lang="ts">
    ...
    import { readItemsStore } from "$lib/stores/readStateStore"; // Import readItemsStore
    ...
    <div role="tablist" class="tabs tabs-bordered mb-6 pl-8">
        ...
        <div class="tab flex-grow justify-end">
            <button
                ...
                data-tip={$_("nav.syncTooltip")}
                aria-label={$_("nav.syncTooltip")}
                onclick={() => readItemsStore.syncAll()}
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
